...
public class BaseTranslator {
     ...
     * for (i < precisionB) {
     * <ol>
     * <li>Keep a carry, initialize to 0.</li>
     * <li>
     * From RIGHT to LEFT
     * <ol>
     * <li>x = multiply the ith digit by baseB and add the carry</li>
     * <li>the new ith digit is x % baseA</li>
     * <li>carry = x / baseA</li>
     * </ol>
     * </li>
     * <li>output[i] = carry</li>
     * </ol>
     * </p>
     * <p>
     * If digits[i] < 0 or digits[i] >= baseA for any i, return null.<br>
    ...
    public static int[] convertBase (int[] digits, int baseA, int baseB, int precisionB) {
        final int[] output = new int[precisionB];
        int carry, x;
